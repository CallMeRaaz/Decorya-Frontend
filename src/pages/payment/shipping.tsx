...
const Shipping = () => {
  ...
  useEffect(() => {
    if (selectedAddressIndex !== -1) {
      ...
      dispatch(saveShippingInfo(selectedShippingInfo));
    } else {
      setShippingInfo({
        name: "",
        email: "",
  ...
  return (
    <section className="max-w-5xl mx-auto pt-28 px-4">
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        ...
        <button
          onClick={() => selectedAddressIndex !== -1 && navigate("/payment")}
          disabled={selectedAddressIndex === -1}
          className={`text-gray-900 bg-gradient-to-r  hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ${
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form onSubmit={submitHandler} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 md:grid-cols-2">
                ...
                <div className="w-full">
                  <label className="block text-gray-600 mb-2" htmlFor="altMob">
              ...
              <div className="grid grid-cols-2 gap-4 md:grid-cols-2">
                ...
                <div className="w-full">
                  <label className="block text-gray-600 mb-2" htmlFor="pinCode">
                    Pincode
                  </label>
                  <input
                    required
